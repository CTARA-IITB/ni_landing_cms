...
if($path == 'www.healthnutritionindia.in'){
        header('Location: https://healthnutritionindia.in/');
}
?>
...
<div class="container-fluid px-0" >
	...
	<div class="p-3 col-12 half-screen">
			...
			<div class="col-md-4 col-12 float-left for-mobile-2">
				...
				<div class="i-icon">
                                                <div class='tree-container'>
                                                        <div class='tree-logo'><a href="/rootCauseAnalysis" target="_blank"><img src="images/2_v1.png" class="tree-size"></a>
                                                        </div>
